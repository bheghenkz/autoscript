...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/bheghenkz/premium/main/ipp | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/bheghenkz/premium/main/ipp | grep $ipsaya | awk '{print $3}')
