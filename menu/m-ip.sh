...
data_ip="https://raw.githubusercontent.com/bheghenkz/premium/main/seler"
checking_sc() {
...
echo -e "         $COLOR1         ${WH}Telegram: t.me/fensmilebots    ${NC}"
echo -e "         $COLOR1      ${WH}Whatsapp: wa.me/6289517087090    ${NC}"
echo -e "         $COLOR1╰══════════════════════════════════════════╯${NC}"
...
checking_sc
clear
Repo1="https://raw.githubusercontent.com/bheghenkz/premium/main/"
...
REPO="https://github.com/bheghenkz/premium.git"
EMAIL="fendysupratno@gmail.com"
USER="bheghenkz"
...
URL="https://api.telegram.org/bot$KEY/sendMessage"
    ...
    git remote add origin https://github.com/bheghenkz/premium
    git push -f https://${TOKEN}@github.com/bheghenkz/premium.git &> /dev/null
    rm -rf /root/ipvps
    clear
    sleep 1
